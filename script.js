...
// Global helper function for closing the drawer
...
// Set up drawer functionality once DOM is loaded
document.addEventListener('DOMContentLoaded', function() {
    // Only set up if the menuBtn exists (we might be on a page without it)
    ...
    // Set up close drawer functionality
